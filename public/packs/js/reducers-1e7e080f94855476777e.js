...
/******/ 	return __webpack_require__(__webpack_require__.s = "./client/src/reducers.js");
/******/ })
/************************************************************************/
/******/ ({
...
var rootReducer = Object(redux__WEBPACK_IMPORTED_MODULE_0__["combineReducers"])({
  reduxTokenAuth: redux_token_auth__WEBPACK_IMPORTED_MODULE_1__["reduxTokenAuthReducer"],
  concepts: conceptsReducer,
  csrfToken: csrfTokenReducer
});

function csrfTokenReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
  return state;
}
  ...
  switch (action.type) {
    case 'FETCH_CONCEPTS':
      ...
      return _objectSpread({}, state, {
        message: {
          title: "Loading",
          content: "Please wait while the Concepts load"
        }
      });

    case 'RECEIVE_CONCEPTS':
      var concepts = action.concepts,
          nouns = action.nouns,
          adjectives = action.adjectives;
    ...
    case 'POST_CONCEPT':
      ...
      return _objectSpread({}, state, {
        message: {
          title: "Sending",
          content: "Now posting your entry"
        }
      });
...
/******/ });
//# sourceMappingURL=reducers-1e7e080f94855476777e.js.map